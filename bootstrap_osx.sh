...
[ ! -f ~/.hgignore_global ] && ln -s ~/.dotfiles/common/hgignore.symlink ~/.hgignore_global

echo "symlink Sublime Text User dir"
rm -r ~/Library/Application\ Support/Sublime\ Text\ 2/Packages/User
ln -s ~/.dotfiles/common/Sublime\ Text/ ~/Library/Application\ Support/Sublime\ Text\ 2/Packages/User
